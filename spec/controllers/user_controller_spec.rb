...
describe UserController do
  context 'Login' do
    ...
    it 'does not let a logged in user view the login page' do
      user = User.create(username: 'testname', email: 'testuser@example.com',
                         password: 'testpass')
      params = {
        username: 'testname',
        password: 'testpass'
  ...
  describe 'Logout' do
    it 'let a logged in user logout' do
      User.create(username: 'testname', email: 'testuser@example.com',
                  password: 'testpass')
      params = {
        username: 'testname',
        password: 'testpass'
  ...
  describe 'Signup action' do
    ...
    it 'does not let a logged in user view the signup page' do
      user = User.create(username: 'realtest', email: 'realtest@example.com',
                         password: 'realpass')
      params = {
        username: 'realtest',
        password: 'realpass'
